...
public class EntityPurpleZombie extends ElementsAdventureQuestMod.ModElement {
	public static final int ENTITYID = 6;
	public static final int ENTITYID_RANGED = 7;
	public EntityPurpleZombie(ElementsAdventureQuestMod instance) {
		super(instance, 86);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("adventurequestmod", "purplezombie"), ENTITYID)
						.name("purplezombie").tracker(64, 3, true).egg(-6750055, -16711885).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelpurplezombie(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("adventurequestmod:textures/purplezombie.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemTrilbiumSword.block, (int) (1)));
		}
	...
	public static class Modelpurplezombie extends ModelBase {
		...
		public Modelpurplezombie() {
			...
			headwear.cubeList.add(new ModelBox(headwear, 32, 0, -4.0F, -3.0F, -4.0F, 8, 8, 8, 0.25F, true));
			body = new ModelRenderer(this);
			body.setRotationPoint(0.0F, 0.0F, 0.0F);
			body.cubeList.add(new ModelBox(body, 16, 16, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F, true));
			left_arm = new ModelRenderer(this);
			left_arm.setRotationPoint(-1.0F, 2.0F, 0.0F);
			left_arm.cubeList.add(new ModelBox(left_arm, 40, 16, 5.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, true));
			right_arm = new ModelRenderer(this);
			right_arm.setRotationPoint(-1.0F, 2.0F, 0.0F);
			right_arm.cubeList.add(new ModelBox(right_arm, 40, 16, -7.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, true));
