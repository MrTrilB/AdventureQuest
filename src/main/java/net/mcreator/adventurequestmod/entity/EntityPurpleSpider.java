...
public class EntityPurpleSpider extends ElementsAdventureQuestMod.ModElement {
	public static final int ENTITYID = 8;
	public static final int ENTITYID_RANGED = 9;
	public EntityPurpleSpider(ElementsAdventureQuestMod instance) {
		super(instance, 88);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("adventurequestmod", "purplespider"), ENTITYID)
						.name("purplespider").tracker(64, 3, true).egg(-65485, -13434829).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelSpider(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("adventurequestmod:textures/purplespider.png");
				}
			};
		});
	}
