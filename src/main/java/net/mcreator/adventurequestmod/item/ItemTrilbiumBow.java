...
public class ItemTrilbiumBow extends ElementsAdventureQuestMod.ModElement {
	@GameRegistry.ObjectHolder("adventurequestmod:trilbiumbow")
	public static final Item block = null;
	public static final int ENTITYID = 3;
	public ItemTrilbiumBow(ElementsAdventureQuestMod instance) {
		super(instance, 72);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("adventurequestmod", "entitybullettrilbiumbow"), ENTITYID).name("entitybullettrilbiumbow")
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("adventurequestmod:trilbiumbow", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(0);
			setFull3D();
			setUnlocalizedName("trilbiumbow");
			setRegistryName("trilbiumbow");
			maxStackSize = 1;
