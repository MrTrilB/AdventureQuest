...
import net.mcreator.adventurequestmod.item.ItemHothDimension;
...
public class WorldHothDimension extends ElementsAdventureQuestMod.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("adventurequestmod:hothdimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldHothDimension(ElementsAdventureQuestMod instance) {
		super(instance, 75);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemHothDimension().setUnlocalizedName("hothdimension").setRegistryName("hothdimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension hothdimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("hothdimension", "_hothdimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemHothDimension.block, 0,
				new ModelResourceLocation("adventurequestmod:hothdimension", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("hothdimension_portal");
			setRegistryName("hothdimension_portal");
			setLightLevel(0F);
		}
